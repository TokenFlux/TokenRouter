export default {
  ...
  marketplace: {
    ...
    statusTimeline: 'Recent Requests',
    ...
    requestStatusSource: 'Recent request success / failure records',
    recentThreeRequests: 'Last 3 requests',
    recentRequestSummary: '{success}/{total} succeeded',
