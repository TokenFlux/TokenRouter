export default {
  ...
  payment: {
    ...
    admin: {
      ...
      group: 'Group',
      groupId: 'Group ID',
      boundGroup: 'Bound OpenAI Groups',
      boundGroupPlaceholder: 'Select OpenAI groups',
      boundGroupHint: 'Subscription plans only apply to API keys using the selected OpenAI groups. You can bind Plus / Pro together.',
