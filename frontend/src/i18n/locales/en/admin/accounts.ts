    ...
    accounts: {
      ...
      advancedSchedulerScore: {
        ...
        filterReasons: {
          ...
          group_upstream_restricted: 'Group upstream model restriction',
      ...
      openai: {
        ...
        codexImageToolDesc:
          'Controls the hosted image_generation bridge and client-declared image tools on Codex /responses text requests. Hosted auto-injection applies only to non-Responses Lite requests. Account policy takes precedence over group defaults and global settings; standalone image-generation endpoints are unaffected.',
        codexImageToolInherit: 'Follow group defaults',
        codexImageToolInheritDesc: 'No account override; hosted injection for non-Lite requests follows the group defaults or global policy, while client-provided hosted tools and local image_gen declarations pass through.',
