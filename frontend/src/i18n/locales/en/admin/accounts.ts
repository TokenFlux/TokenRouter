...
// Accounts
    accounts: {
      ...
      openai: {
        ...
        codexImageToolDesc:
          'Controls the hosted image_generation bridge and client-declared image tools on Codex /responses text requests. Hosted auto-injection applies only to non-Responses Lite requests. Explicit group protocol controls take precedence, followed by account policy and global settings; standalone image-generation endpoints are unaffected.',
        codexImageToolInherit: 'Follow defaults',
        codexImageToolInheritDesc: 'No account override; hosted injection for non-Lite requests follows group protocol controls or global settings, while client-provided hosted tools and local image_gen declarations pass through.',
        ...
        codexImageToolBadgeInherit: 'Default policy',
