    ...
    pricing: {
      defaults: {
        ...
        "keys": {
          ...
          "image_input": "Image input tokens",
          "image_output": "Image output tokens",
          "peak": "Current built-in peak multiplier",
      ...
      noPricingConfigsYet: 'No Price Configurations Yet',
      createFirstPricingConfig: 'Create your first price configuration to manage model pricing',
      loadError: 'Failed to load price configurations',
      createSuccess: 'Price Configuration created',
      updateSuccess: 'Price Configuration updated',
      deleteSuccess: 'Price Configuration deleted',
      createError: 'Failed to create price configuration',
      updateError: 'Failed to update price configuration',
      deleteError: 'Failed to delete price configuration',
      nameRequired: 'Please enter a price configuration name',
      ...
      deleteConfirm: 'Are you sure you want to delete price configuration "{name}"? This cannot be undone.',
      columns: {
        name: 'Name',
      ...
      form: {
        name: 'Name',
        namePlaceholder: 'Enter price configuration name',
        description: 'Description',
        descriptionPlaceholder: 'Optional description',
        status: 'Status',
        groups: 'Associated Groups',
        noGroupsAvailable: 'No groups available',
        inOtherPricingConfig: 'In "{name}"',
        ...
        billingModelSourceGroupMapped: 'Group-mapped model (default)',
        billingModelSourceRequested: 'Client request model',
        billingModelSourceUpstream: 'Account final upstream model',
        billingModelSourceHint: 'Controls which model name is used for pricing and price configuration model restrictions',
        billingModelSourceHintGroupMapped: 'Look up prices using the group-mapped model.',
        billingModelSourceHintRequested: 'Look up prices using the client request model. Model permissions belong to the group.',
        billingModelSourceHintUpstream: 'Look up prices using the final upstream model.',
        ...
        noPlatforms: 'Click "Add Platform" to start configuring the price configuration',
        mappingCount: 'mappings',
        pricingEntry: 'Pricing Entry',
        noModels: 'No models added',
        accountStatsPricingRules: 'Custom Account Stats Pricing Rules',
        addRule: 'Add Rule',
        noRulesConfigured: 'Unmatched requests use gateway default model prices for account cost, independently of custom user prices.',
