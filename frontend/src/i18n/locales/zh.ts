export default {
  ...
  payment: {
    ...
    admin: {
      ...
      group: '分组',
      groupId: '分组 ID',
      boundGroup: '绑定 OpenAI 分组',
      boundGroupPlaceholder: '选择 OpenAI 分组',
      boundGroupHint: '订阅套餐只会应用到使用所选 OpenAI 分组的 API Key，可同时绑定 Plus / Pro。',
      boundGroupRequired: '请至少绑定一个 OpenAI 分组',
      unboundGroup: '未绑定',
      features: '功能特性',
      featuresHint: '每行一个特性',
