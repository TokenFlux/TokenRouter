...
// Accounts Management
    accounts: {
      ...
      openai: {
        ...
        codexImageToolDesc:
          '统一控制 Codex /responses 文本请求的 hosted image_generation 桥接和客户端图片工具声明。hosted 工具自动注入仅适用于非 Responses Lite 请求；账号级策略优先于分组默认值和全局配置，不影响独立图片生成接口。',
        codexImageToolInherit: '跟随分组默认值',
        codexImageToolInheritDesc: '不写入账号覆盖；非 Lite 请求是否注入 hosted 工具由分组默认值或全局策略决定，客户端显式携带的 hosted 工具和本地 image_gen 声明照常放行。',
        ...
        codexImageToolBadgeInherit: '分组默认策略',
