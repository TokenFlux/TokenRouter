...
// 价格管理
    pricing: {
      ...
      title: '价格管理',
      tabs: { configs: '价格配置', defaults: '网关默认价格' },
      description: '管理价格配置和自定义模型定价',
      searchPricingConfigs: '搜索价格配置...',
      createPricingConfig: '创建价格配置',
      editPricingConfig: '编辑价格配置',
      deletePricingConfig: '删除价格配置',
      statusActive: '启用',
      statusDisabled: '停用',
      allStatus: '全部状态',
      groupsUnit: '个分组',
      pricingUnit: '条定价',
      noPricingConfigsYet: '暂无价格配置',
      createFirstPricingConfig: '创建第一个价格配置来管理模型定价',
      loadError: '加载价格配置列表失败',
      createSuccess: '价格配置创建成功',
      updateSuccess: '价格配置更新成功',
      deleteSuccess: '价格配置删除成功',
      createError: '创建价格配置失败',
      updateError: '更新价格配置失败',
      deleteError: '删除价格配置失败',
      nameRequired: '请输入价格配置名称',
      ...
      deleteConfirm: '确定要删除价格配置「{name}」吗？此操作不可撤销。',
      columns: {
        name: '名称',
        description: '描述',
        status: '状态',
      ...
      form: {
        name: '名称',
        namePlaceholder: '输入价格配置名称',
        description: '描述',
        descriptionPlaceholder: '可选描述',
        status: '状态',
        groups: '关联分组',
        noGroupsAvailable: '暂无可用分组',
        inOtherPricingConfig: '已属于「{name}」',
        modelPricing: '模型定价',
        models: '模型列表',
        ...
        billingModelSourceGroupMapped: '分组映射后的模型（默认）',
        billingModelSourceRequested: '客户端请求模型',
        billingModelSourceUpstream: '账号最终上游模型',
        billingModelSourceHint: '控制使用哪个模型名称查找定价并执行价格配置模型限制',
        billingModelSourceHintGroupMapped: '使用分组映射后的模型查价。',
        billingModelSourceHintRequested: '使用客户端请求模型查价，模型权限由分组白名单决定。',
        billingModelSourceHintUpstream: '使用账号最终上游模型查价。',
        ...
        basicSettings: '基础设置',
        addPlatform: '添加平台',
        noPlatforms: '点击"添加平台"开始配置价格配置',
        mappingCount: '条映射',
        pricingEntry: '定价配置',
        noModels: '未添加模型',
        accountStatsPricingRules: '自定义账号统计定价规则',
        addRule: '添加规则',
        noRulesConfigured: '未命中自定义规则时，按网关默认模型价格计算账号成本，不使用用户侧自定义价格。',
        ruleName: '规则名称（可选）',
        ruleGroups: '分组',
        ruleAccounts: '账号',
