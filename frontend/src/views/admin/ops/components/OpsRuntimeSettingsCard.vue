    ...
    <div v-if="draftAlert" class="space-y-4">
      ...
      <div class="rounded-surface bg-gray-50 p-4 dark:bg-dark-950">
        ...
        <label class="inline-flex items-center gap-2 text-sm text-gray-700 dark:text-gray-300">
          <input v-model="draftAlert.silencing.enabled" type="checkbox" class="h-4 w-4 rounded-compact border-gray-300" />
        ...
        <div class="mt-3 grid grid-cols-1 gap-4 md:grid-cols-2">
          <div>
            <label class="inline-flex items-center gap-2 text-xs text-gray-700 dark:text-gray-300">
              <input v-model="draftAlert.distributed_lock.enabled" type="checkbox" class="h-4 w-4 rounded-compact border-gray-300" />
