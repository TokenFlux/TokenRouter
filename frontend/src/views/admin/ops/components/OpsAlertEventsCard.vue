  ...
  <div class="rounded-surface bg-white p-6 shadow-sm ring-1 ring-gray-900/5 dark:bg-dark-900 dark:ring-dark-700">
    <div class="mb-4 flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between sm:gap-4">
      ...
      <div class="flex flex-wrap items-center gap-2">
        ...
        <button
          class="flex items-center gap-1.5 rounded-control bg-gray-100 px-3 py-1.5 text-xs font-bold text-gray-700 transition-colors hover:bg-gray-200 disabled:cursor-not-allowed disabled:opacity-50 dark:bg-dark-950 dark:text-gray-300 dark:hover:bg-dark-800"
          :disabled="loading"
          @click="loadFirstPage"
        >
      ...
      <div class="max-h-[600px] overflow-y-auto" @scroll="onScroll"> <!-- check-ui-allow: 告警事件流局部高度 -->
        <div v-if="!isDesktopViewport" class="divide-y divide-gray-100 dark:divide-dark-800">
          ...
          >
            ...
            <div v-if="row.description" class="line-clamp-2 text-xs text-gray-500 dark:text-gray-400">
              {{ row.description }}
            </div>
    ...
    >
      ...
      <div v-else class="space-y-5">
        <div class="rounded-surface bg-gray-50 p-4 dark:bg-dark-950">
          <div class="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
            ...
            <div class="flex flex-wrap gap-2">
              <div class="flex items-center gap-2 rounded-control bg-white px-2 py-1 ring-1 ring-gray-200 dark:bg-dark-900 dark:ring-dark-700">
                <span class="text-xs font-bold text-gray-600 dark:text-gray-300">{{ t('admin.ops.alertEvents.detail.silence') }}</span>
                <Select
          ...
          <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <div class="rounded-surface bg-gray-50 p-4 dark:bg-dark-950">
              ...
              <div class="mt-1 flex flex-wrap items-center gap-2">
                ...
                <a
                  class="inline-flex items-center gap-1 rounded-compact bg-white px-2 py-1 text-xs font-bold text-gray-700 ring-1 ring-gray-200 hover:bg-gray-50 dark:bg-dark-900 dark:text-gray-200 dark:ring-dark-700 dark:hover:bg-dark-700"
        ...
        <div class="rounded-surface border border-gray-200 bg-white p-4 dark:border-dark-700 dark:bg-dark-900">
          ...
          <div v-else class="overflow-hidden rounded-control border border-gray-100 dark:border-dark-700">
            <table class="min-w-full divide-y divide-gray-100 dark:divide-dark-700">
              <thead class="bg-gray-50 dark:bg-dark-950">
                <tr>
                  <th class="px-3 py-2 text-left text-xs font-bold tracking-wider text-gray-500 dark:text-gray-400">{{ t('admin.ops.alertEvents.table.time') }}</th>
                  <th class="px-3 py-2 text-left text-xs font-bold tracking-wider text-gray-500 dark:text-gray-400">{{ t('admin.ops.alertEvents.table.status') }}</th>
                  <th class="px-3 py-2 text-left text-xs font-bold tracking-wider text-gray-500 dark:text-gray-400">{{ t('admin.ops.alertEvents.table.metric') }}</th>
                </tr>
              </thead>
