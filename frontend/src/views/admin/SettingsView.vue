        ...
        <div class="card">
          <div class="border-b border-gray-100 px-6 py-4 dark:border-dark-700">
            ...
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
              ...
              <a :href="locale === 'zh' ? 'https://github.com/TokenFlux/TokenRouter/blob/main/docs/PAYMENT_CN.md' : 'https://github.com/TokenFlux/TokenRouter/blob/main/docs/PAYMENT.md'" target="_blank" rel="noopener noreferrer" class="ml-2 inline-flex items-center text-primary-600 hover:text-primary-700 dark:text-primary-400 dark:hover:text-primary-300">
...
async function saveSettings() {
  ...
  try {
    ...
    const payload: UpdateSettingsRequest = {
      ...
      registration_email_normalization: form.registration_email_normalization,
