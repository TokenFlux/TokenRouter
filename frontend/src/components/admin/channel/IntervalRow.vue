<template>
  <div class="flex items-start gap-2 rounded-compact border p-2"
    ...
    <template v-else>
      ...
      <div class="flex-1">
        <label class="text-xs text-gray-400">{{ mode === 'video' ? t('admin.channels.form.videoUnitPrice') : mode === 'image' ? t('admin.channels.form.imageUnitPrice') : t('admin.channels.form.perRequestPrice', '单次价格') }} <span v-if="isEmpty" class="text-red-500">*</span> <span class="text-gray-300">$</span></label>
