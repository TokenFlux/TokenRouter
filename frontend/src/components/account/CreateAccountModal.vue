  ...
  >
    ...
    >
      ...
      <div>
        ...
        <div class="mt-2 flex flex-wrap rounded-control bg-gray-100 p-1 dark:bg-dark-700" data-tour="account-form-platform">
          <button
            type="button"
      ...
      <AccountProtocolSelector v-model="upstreamProtocols" :platform="form.platform" :type="form.type" :auth-mode="oauthFlowRef?.inputMethod === 'codex_pat' ? 'personalAccessToken' : oauthFlowRef?.inputMethod === 'agent_identity' ? 'agentIdentity' : ''" />
      ...
      <div class="border-t border-gray-200 pt-4 dark:border-dark-600">
        ...
        <div v-if="form.platform === 'antigravity'" class="flex items-center gap-2">
          ...
          <div class="group relative">
            ...
            <!-- Tooltip（向下显示避免被弹窗裁剪） -->
            <div
              class="pointer-events-none absolute left-0 top-full z-[100] mt-1.5 w-72 rounded-compact bg-gray-900 px-3 py-2 text-xs text-white opacity-0 transition-opacity group-hover:opacity-100 dark:bg-gray-700"
            >
