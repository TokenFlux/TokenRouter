...
func init() {
	...
	groupDescAllowedClientProtocols := groupFields[36].Descriptor()
	...
	groupDescAllowLive := groupFields[37].Descriptor()
	...
	groupDescOpenaiFastPolicy := groupFields[38].Descriptor()
	...
	groupDescForceOpenaiFast := groupFields[39].Descriptor()
	...
	groupDescFreeOpenaiFast := groupFields[40].Descriptor()
	...
	groupDescMaxReasoningEffortOverLimit := groupFields[49].Descriptor()
