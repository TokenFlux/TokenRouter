...
func (_c *SubscriptionPlanGroupCreate) SetSubscriptionPlan(v *SubscriptionPlan) *SubscriptionPlanGroupCreate {
...
func (_c *SubscriptionPlanGroupCreate) check() error {
	...
	if len(_c.mutation.SubscriptionPlanIDs()) == 0 {
		return &ValidationError{Name: "subscription_plan", err: errors.New(`ent: missing required edge "SubscriptionPlanGroup.subscription_plan"`)}
	}
