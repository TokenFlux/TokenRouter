...
func (e SubscriptionPlanGroupEdges) SubscriptionPlanOrErr() (*SubscriptionPlan, error) {
...
func (*SubscriptionPlanGroup) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case subscriptionplangroup.FieldSubscriptionPlanID, subscriptionplangroup.FieldGroupID:
...
// QuerySubscriptionPlan queries the "subscription_plan" edge of the SubscriptionPlanGroup entity.
func (_m *SubscriptionPlanGroup) QuerySubscriptionPlan() *SubscriptionPlanQuery {
	return NewSubscriptionPlanGroupClient(_m.config).QuerySubscriptionPlan(_m)
}
