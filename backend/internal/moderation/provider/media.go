...
func SnapshotMedia(ctx context.Context, media []contract.ContentModerationMedia) []contract.ContentModerationMedia {
	out := append([]contract.ContentModerationMedia(nil), media...)
	if len(out) == 0 {
		return out
	}
