...
func TestS07BucketLeaseExpiredOwnerCannotReleaseSuccessor(t *testing.T) {
	...
	bucket := service.SchedulerBucket{GroupID: 91001, Platform: service.PlatformOpenAI, Mode: service.SchedulerModeSingle}
...
type s07WaitIncrementFault struct{ service.ConcurrencyCache }
...
func TestS07WaitFailOpenDoesNotReleaseOtherRequest(t *testing.T) {
	...
	concurrency := service.NewConcurrencyService(s07WaitIncrementFault{cache})
