...
func newLegacyUsageHandlerFixture(s *service.UsageService, keys *service.APIKeyService, errors *service.OpsService, settings *service.SettingService) *UsageHandler {
	...
	return NewUsageHandler(core, legacyUsageKeys(keys), e, config)
}
