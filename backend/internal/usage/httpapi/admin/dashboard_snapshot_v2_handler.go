...
type dashboardSnapshotV2Response struct {
	...
	Trend      []usage.TrendDataPoint      `json:"trend,omitempty"`
	Models     []usage.ModelStat           `json:"models,omitempty"`
	Groups     []usage.GroupStat           `json:"groups,omitempty"`
	UsersTrend []usage.UserUsageTrendPoint `json:"users_trend,omitempty"`
}
