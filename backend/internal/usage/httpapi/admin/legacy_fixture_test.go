...
func newLegacyUsageHandlerFixture(s *service.UsageService, keys *service.APIKeyService, users service.AdminService, cleanup *service.UsageCleanupService, timing *service.OpsService) *UsageHandler {
	...
	return NewUsageHandler(core, legacyUsageKeys(keys), legacyUsageUsers(users), cleanup, times)
}
