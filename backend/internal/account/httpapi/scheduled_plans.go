...
type ScheduledTestHandler struct {
	scheduledTestSvc *account.ScheduledTestService
}

// NewScheduledTestHandler 只绑定所属账号用例。
func NewScheduledTestHandler(scheduledTestSvc *account.ScheduledTestService) *ScheduledTestHandler {
...
func (h *ScheduledTestHandler) Create(c *gin.Context) {
	...
	plan := &account.ScheduledTestPlan{
