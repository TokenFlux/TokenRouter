...
func TestGrokUsageOwnsProviderAndProbeResults(t *testing.T) {
	...
	core := NewOAuthUsageService(nil, nil, nil, OAuthUsageOptions{Grok: GrokUsageOptions{Available: func() bool { return true }, StatsAvailable: func() bool { return false }, Probe: func(context.Context, int64) (*GrokUsageProbe, error) { return probe, nil }, Build: func(*Record) *UsageInfo { return shared }, Enrich: func(*UsageInfo, *Record) {}}})
	record := &Record{ID: 5, Platform: PlatformGrok, Type: AccountTypeOAuth, Credentials: map[string]any{"refresh_token": "fixture", "access_token": "fixture", "auth_mode": "oauth"}}
