...
func (s *GeminiAccountTest) Target(value *account.Record) account.TestTarget {
	return geminiTestTarget{executor: s, record: value}
}

type geminiTestTarget struct {
	executor *GeminiAccountTest
	record   *account.Record
}

func (t geminiTestTarget) Information() account.TestTargetInfo {
...
func (t geminiTestTarget) Execute(ctx context.Context, request account.PreparedTestRequest, sink account.TestEventSink) error {
