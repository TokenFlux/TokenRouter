...
func TestFilterCodexInput_StripsFunctionCallItemID_WhenPreservingReferences(t *testing.T) {
	...
	filtered := upstreamopenai.FilterCodexInputWithOptions(input, upstreamopenai.CodexInputFilterOptions{
...
func TestFilterCodexInput_PreservesNativeCustomAndToolSearchIDs(t *testing.T) {
	...
	filtered := upstreamopenai.FilterCodexInputWithOptions(input, upstreamopenai.CodexInputFilterOptions{PreserveReferences: true})
