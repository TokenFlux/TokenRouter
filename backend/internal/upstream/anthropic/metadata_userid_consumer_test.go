...
func TestParseMetadataUserID_InvalidInputs(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			require.Nil(t, anthropic.ParseMetadataUserID(tt.raw), "should return nil for: %s", tt.raw)
		})
	}
}
...
func TestParseMetadataUserID_HexCaseInsensitive(t *testing.T) {
	...
	parsed := anthropic.ParseMetadataUserID(rawUpper)
...
func TestFormatMetadataUserID_LegacyVersion(t *testing.T) {
	result := anthropic.FormatMetadataUserID("deadbeef"+"00112233445566778899aabbccddeeff0011223344556677", "acc-uuid", "sess-uuid", "2.1.77")
...
func TestFormatMetadataUserID_NewVersion(t *testing.T) {
	result := anthropic.FormatMetadataUserID("deadbeef"+"00112233445566778899aabbccddeeff0011223344556677", "acc-uuid", "sess-uuid", "2.1.78")
...
func TestFormatMetadataUserID_EmptyVersion_Legacy(t *testing.T) {
	result := anthropic.FormatMetadataUserID("deadbeef"+"00112233445566778899aabbccddeeff0011223344556677", "", "sess-uuid", "")
...
func TestIsNewMetadataFormatVersion(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.version, func(t *testing.T) {
			require.Equal(t, tt.want, anthropic.IsNewMetadataFormatVersion(tt.version))
		})
	}
}
