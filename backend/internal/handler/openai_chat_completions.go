...
func resolveOpenAIUpstreamEndpoint(c *gin.Context, account *service.Account, result *forwardcore.OpenAIResult) string {
	if result != nil {
	...
	return gatewayhttp.GetUpstreamEndpoint(c, account.Platform)
}
