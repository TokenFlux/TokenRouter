...
func newGatewayModelsHandlerWithChannelForTest(repo service.AccountRepository, channelService *routing.ChannelService) *GatewayHandler {
	return &GatewayHandler{
		gatewayService: service.NewGatewayService(
			repo,
			nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil,
			nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, channelService, nil, nil, nil,
		),
	}
}
...
func TestAntigravityModelsIncludesRequestableExactAPIKeyAlias(t *testing.T) {
	...
	c.Set(string(middleware2.ContextKeyAPIKey), &apikey.APIKey{ModelMapping: map[string]string{
...
func TestGatewayModelsCompositeKeyAggregatesMappingsInOrder(t *testing.T) {
	...
	context.Set(string(middleware2.ContextKeyAPIKey), &apikey.APIKey{
		IsComposite: true,
		ModelMapping: map[string]string{
			"review":        "gpt-5",
...
func TestGatewayModels_GrokDefaultsExcludeBuiltinAliases(t *testing.T) {
	...
	mappedContext.Set(string(middleware2.ContextKeyAPIKey), &apikey.APIKey{
