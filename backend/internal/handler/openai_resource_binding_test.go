...
func TestOpenAIHTTPResourceBindingSharesImageCapacity(t *testing.T) {
	...
	h := NewOpenAIGatewayHandler(nil, nil, nil, nil, nil, nil, nil, nil, cfg, nil, resources)
	require.Same(t, resources.Images, h.imageLimiter)
	require.Same(t, resources.Concurrency, h.concurrencyHelper)
