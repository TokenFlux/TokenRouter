...
func registerAccountRoutes(admin *gin.RouterGroup, h *handler.Handlers, stepUpAuth middleware.StepUpAuthMiddleware) {
	accounts := admin.Group("/accounts")
	{
		...
		accounts.GET("/:id/advanced-scheduler-score", h.Admin.AccountManagement.GetAdvancedSchedulerScore)
		accounts.POST("/:id/advanced-scheduler-score/preview", h.Admin.AccountManagement.PreviewAdvancedSchedulerScore)
