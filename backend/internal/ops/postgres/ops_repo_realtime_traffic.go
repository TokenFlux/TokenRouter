...
func (r *Store) GetRealtimeTrafficSummary(ctx context.Context, filter *ops.OpsDashboardFilter) (*ops.OpsRealtimeTrafficSummary, error) {
	if r == nil || r.db == nil {
...
FROM combined`
	...
	return &ops.OpsRealtimeTrafficSummary{
		StartTime: start,
		EndTime:   end,
