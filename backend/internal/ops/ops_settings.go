...
func resolveOpsIgnoredStatusCodesFromRepo(ctx context.Context, repo Settings) []int {
	if repo == nil {
...
// CompatDefaultOpsEmailNotificationConfig 为旧入口提供过渡委托。
func CompatDefaultOpsEmailNotificationConfig() *OpsEmailNotificationConfig {
	return defaultOpsEmailNotificationConfig()
}

// CompatNormalizeOpsEmailNotificationConfig 为旧入口提供过渡委托。
func CompatNormalizeOpsEmailNotificationConfig(cfg *OpsEmailNotificationConfig) {
	normalizeOpsEmailNotificationConfig(cfg)
}

// CompatValidateOpsEmailNotificationConfig 为旧入口提供过渡委托。
func CompatValidateOpsEmailNotificationConfig(cfg *OpsEmailNotificationConfig) error {
	return validateOpsEmailNotificationConfig(cfg)
}

// CompatDefaultOpsAlertRuntimeSettings 为旧入口提供过渡委托。
func CompatDefaultOpsAlertRuntimeSettings() *OpsAlertRuntimeSettings {
	return defaultOpsAlertRuntimeSettings()
}

// CompatNormalizeOpsDistributedLockSettings 为旧入口提供过渡委托。
func CompatNormalizeOpsDistributedLockSettings(s *OpsDistributedLockSettings, defaultKey string, defaultTTLSeconds int) {
	normalizeOpsDistributedLockSettings(s, defaultKey, defaultTTLSeconds)
}

// CompatNormalizeOpsAlertSilencingSettings 为旧入口提供过渡委托。
func CompatNormalizeOpsAlertSilencingSettings(s *OpsAlertSilencingSettings) {
	normalizeOpsAlertSilencingSettings(s)
}

// CompatValidateOpsDistributedLockSettings 为旧入口提供过渡委托。
func CompatValidateOpsDistributedLockSettings(s OpsDistributedLockSettings) error {
	return validateOpsDistributedLockSettings(s)
}

// CompatValidateOpsAlertSilencingSettings 为旧入口提供过渡委托。
func CompatValidateOpsAlertSilencingSettings(s OpsAlertSilencingSettings) error {
	return validateOpsAlertSilencingSettings(s)
}

// CompatDefaultOpsAdvancedSettings 为旧入口提供过渡委托。
func CompatDefaultOpsAdvancedSettings() *OpsAdvancedSettings { return defaultOpsAdvancedSettings() }

// CompatNormalizeOpsAdvancedSettings 为旧入口提供过渡委托。
func CompatNormalizeOpsAdvancedSettings(cfg *OpsAdvancedSettings) { normalizeOpsAdvancedSettings(cfg) }

// CompatClampOpsQuotaAutoPauseThreshold 为旧入口提供过渡委托。
func CompatClampOpsQuotaAutoPauseThreshold(value float64) float64 {
	return clampOpsQuotaAutoPauseThreshold(value)
}

// CompatValidateOpsAdvancedSettings 为旧入口提供过渡委托。
func CompatValidateOpsAdvancedSettings(cfg *OpsAdvancedSettings) error {
	return validateOpsAdvancedSettings(cfg)
}

// CompatCloneOpsIgnoredStatusCodes 为旧入口提供过渡委托。
func CompatCloneOpsIgnoredStatusCodes(codes []int) []int { return cloneOpsIgnoredStatusCodes(codes) }

// CompatResolveOpsIgnoredStatusCodesFromRepo 为旧入口提供过渡委托。
func CompatResolveOpsIgnoredStatusCodesFromRepo(ctx context.Context, repo Settings) []int {
	return resolveOpsIgnoredStatusCodesFromRepo(ctx, repo)
}

// CompatDefaultOpsMetricThresholds 为旧入口提供过渡委托。
func CompatDefaultOpsMetricThresholds() *OpsMetricThresholds { return defaultOpsMetricThresholds() }
