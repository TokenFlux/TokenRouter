...
func (r *ChannelStore) batchLoadAccountStatsPricingRules(ctx context.Context, channelIDs []int64) (map[int64][]routing.AccountStatsPricingRule, error) {
	// 1. 查询规则
	...
	result := make(map[int64][]routing.AccountStatsPricingRule, len(channelIDs))
...
func (r *ChannelStore) batchLoadAccountStatsModelPricing(ctx context.Context, ruleIDs []int64) (map[int64][]routing.ChannelModelPricing, error) {
	if len(ruleIDs) == 0 {
		return make(map[int64][]routing.ChannelModelPricing), nil
	}
	...
	pricingMap := make(map[int64][]routing.ChannelModelPricing, len(ruleIDs))
	for rows.Next() {
...
func (r *ChannelStore) loadAccountStatsPricingRules(ctx context.Context, channelID int64) ([]routing.AccountStatsPricingRule, error) {
...
func replaceAccountStatsPricingRulesTx(ctx context.Context, tx *sql.Tx, channelID int64, rules []routing.AccountStatsPricingRule) error {
...
func createAccountStatsModelPricingTx(ctx context.Context, tx *sql.Tx, ruleID int64, pricing *routing.ChannelModelPricing) error {
...
func (r *ChannelStore) batchLoadAccountStatsIntervals(ctx context.Context, pricingIDs []int64) (map[int64][]routing.PricingInterval, error) {
	if len(pricingIDs) == 0 {
		return nil, nil
	}
	rows, err := r.db.QueryContext(ctx,
