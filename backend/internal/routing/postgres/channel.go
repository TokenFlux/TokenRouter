...
func (r *ChannelStore) Create(ctx context.Context, channel *routing.Channel) error {
	return r.runInTx(ctx, func(tx *sql.Tx) error {
		...
		if err != nil {
			if isUniqueViolation(err) {
				return routing.ErrChannelExists
			}
...
func (r *ChannelStore) GetByID(ctx context.Context, id int64) (*routing.Channel, error) {
	ch := &routing.Channel{}
...
func (r *ChannelStore) Update(ctx context.Context, channel *routing.Channel) error {
	return r.runInTx(ctx, func(tx *sql.Tx) error {
		modelMappingJSON, err := marshalModelMapping(channel.ModelMapping)
		if err != nil {
			return err
		...
		if rows == 0 {
			return routing.ErrChannelNotFound
		}
...
func (r *ChannelStore) Delete(ctx context.Context, id int64) error {
...
func (r *ChannelStore) List(ctx context.Context, params pagination.PaginationParams, status, search string) ([]routing.Channel, *pagination.PaginationResult, error) {
	where := []string{"1=1"}
	args := []any{}
	argIdx := 1
...
func (r *ChannelStore) ListAll(ctx context.Context) ([]routing.Channel, error) {
...
func (r *ChannelStore) batchLoadGroupIDs(ctx context.Context, channelIDs []int64) (map[int64][]int64, error) {
	rows, err := r.db.QueryContext(ctx,
...
func (r *ChannelStore) ExistsByName(ctx context.Context, name string) (bool, error) {
	var exists bool
	err := r.db.QueryRowContext(ctx,
...
func (r *ChannelStore) ExistsByNameExcluding(ctx context.Context, name string, excludeID int64) (bool, error) {
	var exists bool
	err := r.db.QueryRowContext(ctx,
...
func (r *ChannelStore) GetGroupIDs(ctx context.Context, channelID int64) ([]int64, error) {
	rows, err := r.db.QueryContext(ctx,
...
func (r *ChannelStore) SetGroupIDs(ctx context.Context, channelID int64, groupIDs []int64) error {
	return setGroupIDsTx(ctx, r.db, channelID, groupIDs)
}

func (r *ChannelStore) GetChannelIDByGroupID(ctx context.Context, groupID int64) (int64, error) {
	var channelID int64
	err := r.db.QueryRowContext(ctx,
...
func (r *ChannelStore) GetGroupsInOtherChannels(ctx context.Context, channelID int64, groupIDs []int64) ([]int64, error) {
	if len(groupIDs) == 0 {
		return nil, nil
	}
	rows, err := r.db.QueryContext(ctx,
...
func (r *ChannelStore) GetGroupPlatforms(ctx context.Context, groupIDs []int64) (map[int64]string, error) {
	if len(groupIDs) == 0 {
