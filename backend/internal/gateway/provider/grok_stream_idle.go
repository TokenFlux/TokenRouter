...
// GrokStreamIdleFailure 构造响应提交前可见的切换错误，使挂起 Grok 流能更换 OAuth 账号。
func GrokStreamIdleFailure(account *ExecutionAccount, idle time.Duration) *forwardcore.UpstreamFailoverError {
	...
	return &forwardcore.UpstreamFailoverError{
		...
		RetryableOnSameAccount: account != nil && account.Record.Platform == capability.PlatformGrok,
