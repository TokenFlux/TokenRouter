...
func TestValidate_NonMessagesPath_UAOnly(t *testing.T) {
	...
	result := v.Validate(originalClaudeCodeInput(req), nil)
...
func TestValidate_MessagesPath_FullValid(t *testing.T) {
	...
	result := v.Validate(originalClaudeCodeInput(req), validClaudeCodeBody())
...
func TestValidate_MessagesPath_MissingHeaders(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			result := v.Validate(originalClaudeCodeInput(req), body)
...
func TestValidate_MaxTokensOneHaikuBypass(t *testing.T) {
	...
	result := v.Validate(originalClaudeCodeInput(req), map[string]any{"model": "claude-3-haiku", "max_tokens": 1})
