...
func TestIsOnlyWebSearchToolInBody_WebSearchType(t *testing.T) {
	require.True(t, searchtools.IsOnlyWebSearchToolInBody([]byte(`{"tools":[{"type":"web_search"}]}`)))
}

func TestIsOnlyWebSearchToolInBody_WebSearch2025Type(t *testing.T) {
	require.True(t, searchtools.IsOnlyWebSearchToolInBody([]byte(`{"tools":[{"type":"web_search_20250305"}]}`)))
}

func TestIsOnlyWebSearchToolInBody_GoogleSearchType(t *testing.T) {
	require.True(t, searchtools.IsOnlyWebSearchToolInBody([]byte(`{"tools":[{"type":"google_search"}]}`)))
}

func TestIsOnlyWebSearchToolInBody_NameWebSearch(t *testing.T) {
	require.True(t, searchtools.IsOnlyWebSearchToolInBody([]byte(`{"tools":[{"name":"web_search"}]}`)))
}

func TestIsOnlyWebSearchToolInBody_NameWebSearch2025(t *testing.T) {
	require.True(t, searchtools.IsOnlyWebSearchToolInBody([]byte(`{"tools":[{"name":"web_search_20250305"}]}`)))
}

func TestIsOnlyWebSearchToolInBody_NameGoogleSearch(t *testing.T) {
	require.True(t, searchtools.IsOnlyWebSearchToolInBody([]byte(`{"tools":[{"name":"google_search"}]}`)))
}

func TestIsOnlyWebSearchToolInBody_MultipleTools(t *testing.T) {
	require.False(t, searchtools.IsOnlyWebSearchToolInBody(
		[]byte(`{"tools":[{"type":"web_search"},{"type":"text_editor"}]}`)))
}

func TestIsOnlyWebSearchToolInBody_NoTools(t *testing.T) {
	require.False(t, searchtools.IsOnlyWebSearchToolInBody([]byte(`{"model":"claude-3"}`)))
}

func TestIsOnlyWebSearchToolInBody_EmptyToolsArray(t *testing.T) {
	require.False(t, searchtools.IsOnlyWebSearchToolInBody([]byte(`{"tools":[]}`)))
}

func TestIsOnlyWebSearchToolInBody_NonWebSearchTool(t *testing.T) {
	require.False(t, searchtools.IsOnlyWebSearchToolInBody([]byte(`{"tools":[{"type":"text_editor"}]}`)))
}

func TestIsOnlyWebSearchToolInBody_ToolsNotArray(t *testing.T) {
	require.False(t, searchtools.IsOnlyWebSearchToolInBody([]byte(`{"tools":"web_search"}`)))
}

func TestExtractSearchQueryFromBody_StringContent(t *testing.T) {
	body := `{"messages":[{"role":"user","content":"what is golang"}]}`
	require.Equal(t, "what is golang", searchtools.ExtractSearchQueryFromBody([]byte(body)))
}

func TestExtractSearchQueryFromBody_ArrayContent(t *testing.T) {
	body := `{"messages":[{"role":"user","content":[{"type":"text","text":"search this"}]}]}`
	require.Equal(t, "search this", searchtools.ExtractSearchQueryFromBody([]byte(body)))
}
...
func TestExtractSearchQueryFromBody_MultipleMessages(t *testing.T) {
	...
	require.Equal(t, "second", searchtools.ExtractSearchQueryFromBody([]byte(body)))
}
...
func TestExtractSearchQueryFromBody_LastMessageNotUser(t *testing.T) {
	...
	require.Equal(t, "", searchtools.ExtractSearchQueryFromBody([]byte(body)))
}

func TestExtractSearchQueryFromBody_EmptyMessages(t *testing.T) {
	require.Equal(t, "", searchtools.ExtractSearchQueryFromBody([]byte(`{"messages":[]}`)))
}

func TestExtractSearchQueryFromBody_NoMessages(t *testing.T) {
	require.Equal(t, "", searchtools.ExtractSearchQueryFromBody([]byte(`{"model":"claude-3"}`)))
}
...
func TestExtractSearchQueryFromBody_ArrayContentSkipsEmptyText(t *testing.T) {
	...
	require.Equal(t, "real query", searchtools.ExtractSearchQueryFromBody([]byte(body)))
}
...
func TestBuildSearchResultBlocks_WithResults(t *testing.T) {
	...
	blocks := searchtools.BuildSearchResultBlocks(results)
...
func TestBuildSearchResultBlocks_Empty(t *testing.T) {
	blocks := searchtools.BuildSearchResultBlocks(nil)
	require.Empty(t, blocks)
}

func TestBuildSearchResultBlocks_SnippetEmpty(t *testing.T) {
	blocks := searchtools.BuildSearchResultBlocks([]contract.SearchResult{{URL: "https://x.com", Title: "X", Snippet: ""}})
...
func TestBuildTextSummary_WithResults(t *testing.T) {
	...
	summary := searchtools.BuildTextSummary("test query", results)
...
func TestBuildTextSummary_NoResults(t *testing.T) {
	summary := searchtools.BuildTextSummary("test", nil)
