...
func mediaErrorResponseFixture(executor *GrokExecutor, ctx context.Context, resp *http.Response, c *gin.Context, target *provider.ExecutionAccount, requestID, model string) (*forward.OpenAIResult, error) {
	local := *executor
