...
func TestHandleCCBufferedFromAnthropic_ToolArgumentsAreValidJSON(t *testing.T) {
	...
	_, err := forward.ChatBuffered(conversionResponseFixture(resp), gatewayhttp.NewMessageForwardBoundary(c, nil).ConversionOutput(false, &messageforward.AttemptState{}), "gpt-5", "claude-sonnet-4.5", nil, time.Now())
...
func TestHandleCCBufferedFromAnthropic_PreservesMessageStartCacheUsageAndReasoning(t *testing.T) {
	...
	result, err := forward.ChatBuffered(conversionResponseFixture(resp), gatewayhttp.NewMessageForwardBoundary(c, nil).ConversionOutput(false, &messageforward.AttemptState{}), "gpt-5", "claude-sonnet-4.5", &reasoningEffort, time.Now())
	require.NoError(t, err)
...
func TestHandleCCBufferedFromAnthropic_CompactSSEFormat(t *testing.T) {
	...
	result, err := forward.ChatBuffered(conversionResponseFixture(resp), gatewayhttp.NewMessageForwardBoundary(c, nil).ConversionOutput(false, &messageforward.AttemptState{}), "k3", "k3", nil, time.Now())
	require.NoError(t, err)
	require.NotNil(t, result)
...
func TestHandleCCStreamingFromAnthropic_CompactSSEFormat(t *testing.T) {
	...
	result, err := forward.ChatStreaming(conversionResponseFixture(resp), gatewayhttp.NewMessageForwardBoundary(c, nil).ConversionOutput(false, &messageforward.AttemptState{}), "k3", "k3", nil, time.Now(), true)
	require.NoError(t, err)
	require.NotNil(t, result)
...
func TestHandleCCStreamingFromAnthropic_PreservesMessageStartCacheUsageAndReasoning(t *testing.T) {
	...
	result, err := forward.ChatStreaming(conversionResponseFixture(resp), gatewayhttp.NewMessageForwardBoundary(c, nil).ConversionOutput(false, &messageforward.AttemptState{}), "gpt-5", "claude-sonnet-4.5", &reasoningEffort, time.Now(), true)
	require.NoError(t, err)
	require.NotNil(t, result)
...
func TestHandleCCBufferedFromAnthropic_WritesToolCall(t *testing.T) {
	...
	result, err := forward.ChatBuffered(conversionResponseFixture(resp), gatewayhttp.NewMessageForwardBoundary(c, nil).ConversionOutput(false, &messageforward.AttemptState{}), "gpt-5", "claude-sonnet-4.5", nil, time.Now())
	require.NoError(t, err)
	require.NotNil(t, result)
