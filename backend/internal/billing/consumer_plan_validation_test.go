...
func TestValidatePlanRequired_AllValid(t *testing.T) {
	err := billing.ValidatePlanRequired("Pro", 9.99, 30, "days", nil)
	require.NoError(t, err)
}

func TestValidatePlanRequired_EmptyName(t *testing.T) {
	err := billing.ValidatePlanRequired("", 9.99, 30, "days", nil)
	require.Error(t, err)
...
func TestValidatePlanRequired_NameValidatedFirst(t *testing.T) {
	err := billing.ValidatePlanRequired("", 0, 0, "", nil)
	require.Error(t, err)
	require.Contains(t, err.Error(), "plan name")
}
...
func TestValidatePlanRequired_NegativeOriginalPrice(t *testing.T) {
	neg := -10.0
	err := billing.ValidatePlanRequired("Pro", 9.99, 30, "days", &neg)
	require.Error(t, err)
...
func TestValidatePlanRequired_ZeroOriginalPrice(t *testing.T) {
	zero := 0.0
	err := billing.ValidatePlanRequired("Pro", 9.99, 30, "days", &zero)
	require.NoError(t, err)
}

func TestValidatePlanRequired_ValidOriginalPrice(t *testing.T) {
	op := 19.99
	err := billing.ValidatePlanRequired("Pro", 9.99, 30, "days", &op)
	require.NoError(t, err)
}

// --- billing.ValidatePlanPatch tests ---

func TestValidatePlanPatch_NegativeOriginalPrice(t *testing.T) {
	neg := -5.0
	err := billing.ValidatePlanPatch(billing.UpdatePlanRequest{OriginalPrice: nullablePatchFloat(neg)})
	require.Error(t, err)
	require.Contains(t, err.Error(), "original price")
}
...
func TestValidatePlanPatch_ZeroOriginalPrice(t *testing.T) {
	zero := 0.0
	err := billing.ValidatePlanPatch(billing.UpdatePlanRequest{OriginalPrice: billing.NullableFloat64Patch{Present: true, Value: &zero}})
	require.NoError(t, err)
}

func TestValidatePlanPatch_ValidOriginalPrice(t *testing.T) {
	op := 29.99
	err := billing.ValidatePlanPatch(billing.UpdatePlanRequest{OriginalPrice: nullablePatchFloat(op)})
	require.NoError(t, err)
}

func TestValidatePlanPatch_NilOriginalPrice(t *testing.T) {
	err := billing.ValidatePlanPatch(billing.UpdatePlanRequest{OriginalPrice: billing.NullableFloat64Patch{Present: true}})
	require.NoError(t, err)
}

// --- billing.ValidatePlanPatch: other fields ---

func ptrStr(s string) *string     { return &s }
func ptrInt(i int) *int           { return &i }
func ptrInt64(i int64) *int64     { return &i }
func ptrFloat(f float64) *float64 { return &f }
func nullablePatchFloat(f float64) billing.NullableFloat64Patch {
	return billing.NullableFloat64Patch{Present: true, Value: &f}
}

func TestUpdatePlanRequest_UnmarshalNullablePatchFields(t *testing.T) {
	var omitted billing.UpdatePlanRequest
	...
	var patched billing.UpdatePlanRequest
...
func TestValidatePlanPatch_NegativeQuotaLimit(t *testing.T) {
	err := billing.ValidatePlanPatch(billing.UpdatePlanRequest{WeeklyLimitUSD: nullablePatchFloat(-1)})
	require.Error(t, err)
	require.Contains(t, err.Error(), "weekly limit")
}

func TestValidatePlanPatch_EmptyName(t *testing.T) {
	err := billing.ValidatePlanPatch(billing.UpdatePlanRequest{Name: ptrStr("")})
	require.Error(t, err)
	require.Contains(t, err.Error(), "plan name")
}

func TestValidatePlanPatch_ValidName(t *testing.T) {
	err := billing.ValidatePlanPatch(billing.UpdatePlanRequest{Name: ptrStr("Basic")})
	require.NoError(t, err)
}

func TestValidatePlanPatch_GroupIDIgnored(t *testing.T) {
	err := billing.ValidatePlanPatch(billing.UpdatePlanRequest{GroupID: ptrInt64(0)})
	require.NoError(t, err)
}

func TestValidatePlanPatch_NegativePrice(t *testing.T) {
	err := billing.ValidatePlanPatch(billing.UpdatePlanRequest{Price: ptrFloat(-1)})
	require.Error(t, err)
	require.Contains(t, err.Error(), "price")
}

func TestValidatePlanPatch_ZeroPrice(t *testing.T) {
	err := billing.ValidatePlanPatch(billing.UpdatePlanRequest{Price: ptrFloat(0)})
	require.Error(t, err)
	require.Contains(t, err.Error(), "price")
}

func TestValidatePlanPatch_ValidPrice(t *testing.T) {
	err := billing.ValidatePlanPatch(billing.UpdatePlanRequest{Price: ptrFloat(9.99)})
	require.NoError(t, err)
}

func TestValidatePlanPatch_ZeroValidityDays(t *testing.T) {
	err := billing.ValidatePlanPatch(billing.UpdatePlanRequest{ValidityDays: ptrInt(0)})
	require.Error(t, err)
	require.Contains(t, err.Error(), "validity days")
}

func TestValidatePlanPatch_EmptyValidityUnit(t *testing.T) {
	err := billing.ValidatePlanPatch(billing.UpdatePlanRequest{ValidityUnit: ptrStr("")})
	require.Error(t, err)
	require.Contains(t, err.Error(), "validity unit")
}

func TestValidatePlanPatch_ValidValidityUnit(t *testing.T) {
	err := billing.ValidatePlanPatch(billing.UpdatePlanRequest{ValidityUnit: ptrStr("days")})
	require.NoError(t, err)
}

func TestValidatePlanPatch_AllNil(t *testing.T) {
	err := billing.ValidatePlanPatch(billing.UpdatePlanRequest{})
	require.NoError(t, err)
}

// billing.NormalizePlanCurrency 必须保留空值，避免存量套餐被自动补成默认支付币种。

func TestNormalizePlanCurrency_EmptyKeepsEmpty(t *testing.T) {
	currency, err := billing.NormalizePlanCurrency("")
	require.NoError(t, err)
