...
func UserSubscriptionFromServiceAdmin(sub *billing.UserSubscription) *AdminUserSubscription {
	...
	return &AdminUserSubscription{
		...
		Notes:            sub.Notes,
		AssignedByUser:   userSummaryResponse(sub.AssignedByUser),
	}
}
...
func userSubscriptionFromServiceBase(sub *billing.UserSubscription) UserSubscription {
	return UserSubscription{
		...
		User:               userSummaryResponse(sub.User),
...
func userSummaryResponse(u *billing.UserSummary) *UserSummaryResponse {
	if u == nil {
		return nil
	}
