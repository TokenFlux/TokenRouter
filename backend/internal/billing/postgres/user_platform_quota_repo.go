...
func (r *PlatformQuotaStore) BulkInsertInitial(ctx context.Context, records []UserPlatformQuotaRecord) error {
	if len(records) == 0 {
		return nil
	}
...
func (r *PlatformQuotaStore) GetByUserPlatform(ctx context.Context, userID int64, platform string) (*UserPlatformQuotaRecord, error) {
	client := clientFromContext(ctx, r.client)
...
func (r *PlatformQuotaStore) ListByUser(ctx context.Context, userID int64) ([]UserPlatformQuotaRecord, error) {
	client := clientFromContext(ctx, r.client)
...
func (r *PlatformQuotaStore) IncrementUsageWithReset(ctx context.Context, userID int64, platform string, cost float64, now time.Time) error {
...
func (r *PlatformQuotaStore) ResetExpiredWindow(ctx context.Context, userID int64, platform string, window string, newStart time.Time) error {
	client := clientFromContext(ctx, r.client)
...
func (r *PlatformQuotaStore) withTx(ctx context.Context, fn func(txCtx context.Context, txClient *dbent.Client) error) error {
...
func (r *PlatformQuotaStore) UpsertForUser(ctx context.Context, userID int64, records []UserPlatformQuotaRecord) error {
	return r.withTx(ctx, func(txCtx context.Context, txClient *dbent.Client) error {
...
func (r *PlatformQuotaStore) BatchSnapshotUsage(ctx context.Context, snapshots []UserPlatformQuotaSnapshot, now time.Time) error {
	if len(snapshots) == 0 {
		return nil
	}
