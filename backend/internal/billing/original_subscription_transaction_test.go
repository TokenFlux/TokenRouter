...
func TestExtendSubscriptionReusesCallerTransaction(t *testing.T) {
	...
	svc := billing.NewSubscriptionService(nil, repo, &subscriptionContextTransactions{SubscriptionMutations: billingpostgres.NewSubscriptionMutations(nil), t: t, tx: tx}, originalSubscriptionClock())
