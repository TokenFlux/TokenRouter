...
func ParseSSEUsagePassthrough(data string, usage *protocol.TokenUsage) {
...
// 别名，因此保持原样。
func NormalizeAnthropicCompatiblePromptUsage(usageNode gjson.Result, usage *protocol.TokenUsage) bool {
