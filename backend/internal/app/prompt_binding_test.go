...
func TestPromptPolicyDirectHTTPBindingSharesCache(t *testing.T) {
	...
	first := provideCountTokensHTTP(nil, nil, nil, nil, nil, nil, nil, prompts, nil, nil, nil)
	second := provideCountTokensHTTP(nil, nil, nil, nil, nil, nil, nil, prompts, nil, nil, nil)
