...
func TestAnthropicReasoningPolicy_AllEntrypointsDeny(t *testing.T) {
	h := newMessageEndpointsFixture(nil, nil, nil, gatewayhttp.MessagesHTTPOptions{MaxBodyBytes: openAITextOptions(nil).MaxBodyBytes, MaxSwitches: 0, MaxGeminiSwitches: 0}, nil, nil)
