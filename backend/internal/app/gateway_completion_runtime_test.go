...
func TestCompletionRuntimeOwnsIsolatedRatesAndSharedRecorders(t *testing.T) {
	...
	openai := provideOpenAIGatewayExecution(nil, nil, cfg, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, recorders, nil, nil, nil, nil, nil, nil, nil, nil, nil, &gatewayhttp.GrokExecutor{})
	...
	bindings := openai.PromptCacheBindings()
	bindings.Bind(5, 7, "s:a-u:b", "cache-key", "", time.Hour)
	require.Same(t, bindings, openai.PromptCacheBindings())
	cacheKey, _ := openai.PromptCacheBindings().Find(5, 7, "s:a-u:b-a:c")
