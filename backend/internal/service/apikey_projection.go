...
func APIKeyGroupView(g *Group) *apikey.Group { return apikey.GroupFromRouting(groupRules(g)) }

func GroupFromAPIKeyView(g *apikey.Group) *Group { return GroupFromRouting(apikey.RoutingGroup(g)) }
