...
func TestS06UpstreamUsageSingleflightResultIsolation(t *testing.T) {
	value := &Account{ID: 5, Platform: PlatformOpenAI, Type: AccountTypeAPIKey, Status: StatusActive, Credentials: map[string]any{"api_key": "fixture", "base_url": "https://usage.example/v1"}}
	...
	results := make(chan *UpstreamUsageQueryResult, 2)
