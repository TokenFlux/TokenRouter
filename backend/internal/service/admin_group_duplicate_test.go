...
func TestDuplicateGroupCopiesConfigurationDeeplyAndResetsRuntimeState(t *testing.T) {
	...
	source := &Group{
		...
		ModelPricing:                testImageModelPricing(map[string]*float64{"1K": groupDuplicateTestPointer(0.01), "2K": groupDuplicateTestPointer(0.02), "4K": groupDuplicateTestPointer(0.04)}),
	}
