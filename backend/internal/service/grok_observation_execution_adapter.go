...
func (a grokObservationAdapter) Stamp(snapshot *nativegrok.QuotaSnapshot, model string) {
	stampGrokQuotaSnapshotForPlan(a.account, snapshot, model)
}
func (a grokObservationAdapter) Store(ctx context.Context, snapshot *nativegrok.QuotaSnapshot) {
	a.s.updateGrokUsageSnapshot(ctx, a.account, snapshot)
}
func (a grokObservationAdapter) Recovery(snapshot *nativegrok.QuotaSnapshot) bool {
