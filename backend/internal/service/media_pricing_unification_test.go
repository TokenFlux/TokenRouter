...
func TestAsyncImageUnitPricingUsesCardsAndPerImageFallback(t *testing.T) {
	...
	billing := NewBillingService(nil, nil)
	billing.pricingService = &PricingService{pricingData: map[string]*LiteLLMModelPricing{model: {OutputCostPerToken: 0.000001, OutputCostPerImageToken: 0.000002, OutputCostPerImage: 0.2}}}
