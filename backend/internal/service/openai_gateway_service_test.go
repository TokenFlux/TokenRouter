...
func (c stubConcurrencyCache) GetAccountsLoadBatch(ctx context.Context, accounts []schedulercore.AccountWithConcurrency) (map[int64]*schedulercore.AccountLoadInfo, error) {
