...
type CodexInviteResetStatus = account.CodexInviteResetStatus

type CodexInviteResetCredit = account.CodexInviteResetCredit

type CodexInviteResetInviteResult = account.CodexInviteResetInviteResult

type CodexInviteResetConsumeResult = account.CodexInviteResetConsumeResult
