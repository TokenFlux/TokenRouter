...
func (*s13CleanupRepo) ListBatchImageJobsDueForInputCleanup(ctx context.Context, _ time.Time, _ int) ([]*BatchImageJob, error) {
	return nil, ctx.Err()
}
func (*s13CleanupRepo) ListBatchImageJobsDueForOutputCleanup(ctx context.Context, _ time.Time, _ int) ([]*BatchImageJob, error) {
	return nil, ctx.Err()
}
