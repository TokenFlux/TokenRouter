...
type OpsUpstreamErrorEvent = ops.OpsUpstreamErrorEvent
...
func ParseOpsUpstreamErrors(raw string) ([]*OpsUpstreamErrorEvent, error) {
	return ops.ParseOpsUpstreamErrors(raw)
}

func safeUpstreamURL(rawURL string) string { return ops.CompatSafeUpstreamURL(rawURL) }
