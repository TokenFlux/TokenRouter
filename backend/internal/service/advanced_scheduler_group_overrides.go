...
func (s *OpenAIGatewayService) advancedSchedulerEffectiveSettingsForGroup(ctx context.Context, group *routing.Group) policy.EffectiveSettings {
	var parameters *scheduler.Parameters
	if s != nil {
...
func (s *OpenAIGatewayService) advancedSchedulerGroupForRequest(ctx context.Context, id *int64) *routing.Group {
